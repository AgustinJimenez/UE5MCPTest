...
protected:
	...
	// Calculate movement direction from velocity relative to actor rotation
...
private:
	...
	// SteeringTime accumulator — how long the player has been steering in the current direction
	...
	// Push MovementMode/Gait to AnimInstance via FByteProperty (bypasses BP enum type mismatch)
